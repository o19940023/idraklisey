...
class ApiConfig {
  ...
  // Notifications
  static const String GET_LATEST_NOTIFICATIONS =
      '/panel/notifications/get-latest';
  ...
  static const String TRANSITION_EXCEPTIONS =
      '/panel/academic/transitions/exceptions';
  ...
  static const String CURRICULUMS =
      '/panel/academic/operations/curriculums/manage';
  static const String CLUBS = '/panel/academic/clubs';

  // Academic - Foundations
  static const String ACADEMIC_YEARS =
      '/panel/academic/foundations/academic-years';
  ...
  // Finance
  static const String STUDENT_INVOICES =
      '/panel/academic/finance/student-invoices';
  static const String PAYROLL = '/panel/academic/finance/payroll';
  static const String SALARY_LIST =
      '/panel/academic/finance/payroll/salary-list';
  ...
  // Finance Dictionary
  static const String EXTERNAL_ENTITIES =
      '/panel/academic/finance/dictionary/external-entities';
  static const String NOTE_TEMPLATES =
      '/panel/academic/finance/dictionary/note-templates';
  static const String TRANSPORT_RATES =
      '/panel/academic/finance/dictionary/transport-rates';
  static const String FINANCE_CATEGORIES =
      '/panel/academic/finance/dictionary/categories';

  // Warehouse
  static const String INVENTORIZATIONS =
      '/panel/warehouse_actions/inventorizations';
  ...
  static const String STUDENT_APPLICATIONS =
      '/panel/exams/student_first_time_applications';
  ...
  static const String BOOK_RESERVATIONS =
      '/panel/academic/library/book-reservations';
  ...
  static const String PERFORMANCE_STATS =
      '/panel/academic/teachers/statistics/performance';
  static const String ASSIGNMENT_STATS =
      '/panel/academic/teachers/statistics/assignments';
  static const String ADMISSION_STATS =
      '/panel/academic/teachers/statistics/admissions';
  static const String LEAVER_STATS =
      '/panel/academic/teachers/statistics/leavers';
  static const String MONTHLY_STATS = '/panel/statistics/monthly';
  static const String WAREHOUSE_STATS =
      '/panel/academic/teachers/statistics/warehouse';
  static const String WORKLOAD_REPORT =
      '/panel/academic/teachers/teachers/workload-report-v2';
  ...
  static const String DOCUMENT_TEMPLATES =
      '/panel/structure/document_templates';
